...
class PeriodoAcademicoRepository(BaseRepository):
    """Repositorio para la persistencia de periodos académicos."""

    def obtener_todos(self) -> List[Dict[str, Any]]:
        return self._json_manager.leer_archivo(self._ruta_archivo)

    def obtener_por_id(self, id: Any) -> Optional[Dict[str, Any]]:
        for periodo in self.obtener_todos():
            if isinstance(periodo, dict) and periodo.get("id") == id:
                return periodo
        return None
